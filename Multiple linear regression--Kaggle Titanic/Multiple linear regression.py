...
# median()--numpy函数，求中位数
train.describe()
# Pandas函数，描述一维或二维表的各种统计量（和、均值、标准差等等）
...
theta = np.ones(x_norm.shape[1]).reshape(-1, 1)
# 初始化参数矩阵
...
resultFile.to_csv('data/submission.csv', index=None)